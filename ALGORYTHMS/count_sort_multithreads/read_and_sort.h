...
void consider_numbers(bool& get_file_thread_finished, std::vector<size_t>& numbers_from_file,
                   std::vector<bool>& uniq_numbers_bool_vec, std::vector<size_t>& numbers_bit_vec,  print_debug& debug);
void sort_vec(std::vector<size_t>& numbers_from_file, std::vector<bool>& uniq_numbers_bool_vec, print_debug& debug);
void sort_numbers(std::vector<size_t>& numbers_from_file, std::vector<size_t>& numbers_bit_vec, print_debug& debug);
