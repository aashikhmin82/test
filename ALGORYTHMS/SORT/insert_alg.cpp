...
//        cout << arr1[i] << ' ';
    ...
    test_algorithm(insertion, "Insert sort", arr1, currItem);
    test_algorithm(merge_sort, "Merge sort", arr1, currItem);
    test_algorithm(counting_sort, "Couning sort", arr1, currItem);
    test_algorithm(std_sort, "C++ std::sort", arr1, currItem);
    test_algorithm(heapsort, "Heap sort", arr1, currItem);
    test_algorithm(quick_sort, "Quick sort", arr1, currItem);
    test_algorithm(counting_sort1, "Counting sort1", arr1, currItem);
    test_algorithm(radix_sort, "Radix sort", arr1, currItem);
